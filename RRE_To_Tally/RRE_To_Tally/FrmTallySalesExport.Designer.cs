...
partial class FrmTallySalesExport
{
    ...
    private void InitializeComponent()
    {
        ...
        Label lblCompany = MakeLabel("Company", 540, 76);
        ...
        cboCompany.Location = new Point(540, 99);
        cboCompany.Name = "cboCompany";
        cboCompany.Size = new Size(245, 23);
        cboCompany.SelectedIndexChanged += cboCompany_SelectedIndexChanged;
        btnLoadData = MakeButton("Load Data", 804, 96, 110);
        btnLoadData.Click += btnLoadData_Click;
        btnGenerateMasters = MakeButton("Generate Masters XML", 930, 96, 160);
        btnGenerateMasters.Click += btnGenerateMasters_Click;
        btnGenerateSales = MakeButton("Generate Sales XML", 18, 137, 150);
        btnGenerateSales.Click += btnGenerateSales_Click;
        btnGenerateBoth = MakeButton("Generate Both", 182, 137, 120);
        btnGenerateBoth.Click += btnGenerateBoth_Click;
        btnOpenFolder = MakeButton("Open Export Folder", 1002, 137, 160);
        btnOpenFolder.Click += btnOpenFolder_Click;
        Label lblFolder = MakeLabel("Export folder", 320, 142);
        txtExportFolder.Location = new Point(414, 139);
        txtExportFolder.Name = "txtExportFolder";
        txtExportFolder.Size = new Size(473, 23);
        ...
        dgvInvoices.Columns.Add(MakeTextColumn("Bill Number", "SalesId", 110));
        ...
        dgvInvoices.Columns.Add(MakeTextColumn("Invoice value", "CalculatedTotal", 115, "0.00"));
        btnSelectAll = MakeButton("Select All", 18, 260, 100);
        btnSelectAll.Click += btnSelectAll_Click;
        btnDeselectAll = MakeButton("Deselect All", 132, 260, 110);
