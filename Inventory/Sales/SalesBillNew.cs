...
{   
    public partial class SalesBillNew : Form
    {
       ...
       // string checkval = string.Empty;
        ...
        public SalesBillNew()
        {
            ...
            SearchCreteria2();
            SearchCreteria3();
            //Txtpackinsearch.AutoCompleteMode = AutoCompleteMode.SuggestAppend;
            //Txtpackinsearch.AutoCompleteCustomSource = ClientListDropDown();
            //Txtpackinsearch.AutoCompleteSource = AutoCompleteSource.CustomSource;
            ...
            else if (selectedtab == "TabCreditPayment")
            {

                SearchCreditPayment("Estimationid", "", "Updatedon", "Today", "customername", "", role1, Program.userid);
            ...
            // MainTabSalesBill.TabPages.Remove(TabFloorCheckOut);
            MainTabSalesBill.TabPages.Remove(TabChecking);
            MainTabSalesBill.TabPages.Remove(TabCreditPayment);
            ...
            bool contains = dt1.AsEnumerable()
                .Any(row => "SalesPacking" == row.Field<String>("Data"));
            if (contains == false)
            {
                MainTabSalesBill.TabPages.Remove(TabFloorCheckOut);
                btnPrint.Enabled = true;
       ...
       .Any(row => "SalesEstimationReturnApproval" == row.Field<String>("Data"));
            if (contains5 == false)
            {
                MainTabSalesBill.TabPages.Remove(TapReturnApproval);
                btnPrint.Enabled = false;
            ...
            .Any(row => "SalesEstimationReturnChecking" == row.Field<String>("Data"));
            if (contains6 == false)
            {
                MainTabSalesBill.TabPages.Remove(TapReturnCheckin);
                btnPrint.Enabled = false;
            ...
            bool contains1 = dt1.AsEnumerable()
               .Any(row => "SalesEstimationCreditapproval" == row.Field<String>("Data"));
            if (contains1 == false)
            {
                MainTabSalesBill.TabPages.Remove(TabCreditApproval);
                btnPrint.Enabled = false;
            ...
            bool contains2 = dt1.AsEnumerable()
               .Any(row => "SalesEstimationPayment" == row.Field<String>("Data"));
            if (contains2 == false)
            {
                MainTabSalesBill.TabPages.Remove(TabPayment);
                btnPrint.Enabled = false;
            ...
            bool contains3 = dt1.AsEnumerable()
              .Any(row => "SalesEstimationCreditPayment" == row.Field<String>("Data"));
            if (contains2 == false)
            {
                MainTabSalesBill.TabPages.Remove(TabCreditPayment);
                btnPrint.Enabled = false;
            ...
            //bool contains3 = dt1.AsEnumerable()
            // .Any(row => "SalesEstimationChecking" == row.Field<String>("Data"));
            //if (contains3 == false)
            //{
            //    MainTabSalesBill.TabPages.Remove(TabChecking);
            //    btnPrint.Enabled = false;
            ...
            .Any(row => "SalesEstimationDelivery" == row.Field<String>("Data"));
            if (contains4 == false)
            {
                MainTabSalesBill.TabPages.Remove(TabDelivery);
                btnPrint.Enabled = false;
        ...
        private void LoadCreditPayment()
        {
            dvgcreditpayment.Rows.Clear();
            dvgcreditpayment.ColumnCount = 7;
            //dgvOrder.RowCount = 16;

            dvgcreditpayment.Columns[0].Name = "S.NO";
            dvgcreditpayment.Columns[1].Name = "Items";
            dvgcreditpayment.Columns[2].Name = "UOM";
            dvgcreditpayment.Columns[5].Name = "Quantity";
            dvgcreditpayment.Columns[3].Name = "productid";
            dvgcreditpayment.Columns[4].Name = "Rate";
            dvgcreditpayment.Columns[6].Name = "Amount";

            dvgcreditpayment.Columns[3].Visible = false;

            this.dvgcreditpayment.Columns[0].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;

            this.dvgcreditpayment.Columns[0].SortMode = DataGridViewColumnSortMode.NotSortable;
            this.dvgcreditpayment.Columns[1].SortMode = DataGridViewColumnSortMode.NotSortable;
            this.dvgcreditpayment.Columns[2].SortMode = DataGridViewColumnSortMode.NotSortable;
            this.dvgcreditpayment.Columns[4].SortMode = DataGridViewColumnSortMode.NotSortable;
            this.dvgcreditpayment.Columns[5].SortMode = DataGridViewColumnSortMode.NotSortable;
            this.dvgcreditpayment.Columns[6].SortMode = DataGridViewColumnSortMode.NotSortable;


            this.dvgcreditpayment.Columns[1].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;

            this.dvgcreditpayment.Columns[0].ReadOnly = true;
            this.dvgcreditpayment.Columns[1].ReadOnly = true;
            this.dvgcreditpayment.Columns[2].ReadOnly = true;
            this.dvgcreditpayment.Columns[6].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dvgcreditpayment.Columns[4].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dvgcreditpayment.Columns[5].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;



            this.dvgcreditpayment.Columns[4].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;

            this.dvgcreditpayment.Columns[4].ReadOnly = true;
            this.dvgcreditpayment.Columns[5].ReadOnly = true;

            this.dvgcreditpayment.Columns[5].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;


            dvgcreditpayment.Columns[4].DefaultCellStyle.Format = "N2";
            dvgcreditpayment.Columns[6].DefaultCellStyle.Format = "N2";

            this.dvgcreditpayment.Columns[6].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;


            this.dvgcreditpayment.Columns[6].ReadOnly = true;
            ...
            if (w == 1024 && h == 768)
            {
                this.dvgcreditpayment.Columns[0].Width = 15;
                this.dvgcreditpayment.Columns[1].Width = 100;
                this.dvgcreditpayment.Columns[2].Width = 15;
                this.dvgcreditpayment.Columns[4].Width = 15;
                this.dvgcreditpayment.Columns[5].Width = 25;
                this.dvgcreditpayment.Columns[6].Width = 100;
            }
            else
            {
                this.dvgcreditpayment.Columns[0].Width = 15;
                ...
                this.dvgcreditpayment.Columns[2].Width = 15;
                this.dvgcreditpayment.Columns[4].Width = 15;
                this.dvgcreditpayment.Columns[5].Width = 12;
                this.dvgcreditpayment.Columns[6].Width = 100;

            }

            dvgcreditpayment.ColumnHeadersDefaultCellStyle.Font = new Font("Arial", 9.1F, FontStyle.Bold);

            foreach (DataGridViewColumn c in dvgcreditpayment.Columns)
            {
                c.DefaultCellStyle.Font = new Font("Arial", 12F, GraphicsUnit.Pixel);
            }
        ...
        private void LoadPortsFloorCheckOut()
        {
            ...
            dgvFloorCheckOut.Columns["Productid"].Visible = false;
            dgvFloorCheckOut.Columns["Rack"].Visible = false;
            dgvFloorCheckOut.Columns["Location"].Visible = false;
            dgvFloorCheckOut.Columns["ChkFloorCheckOut"].Visible = false;
        ...
        private void LoadPortsdgvpacking()
        {
            dgvpacking.Rows.Clear();
            dgvpacking.ColumnCount = 3;


            dgvpacking.Columns[0].Name = "S.NO";
            dgvpacking.Columns[1].Name = "PackingItems";
            dgvpacking.Columns[2].Name = "Quantity";



            this.dgvpacking.Columns[0].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;




            this.dgvpacking.Columns[0].SortMode = DataGridViewColumnSortMode.NotSortable;
            this.dgvpacking.Columns[1].SortMode = DataGridViewColumnSortMode.NotSortable;
            this.dgvpacking.Columns[2].SortMode = DataGridViewColumnSortMode.NotSortable;


            this.dgvpacking.Columns[2].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgvpacking.Columns[1].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;



            this.dgvpacking.Columns[0].ReadOnly = true;
            this.dgvpacking.Columns[1].ReadOnly = true;
            //this.dgvpacking.Columns[1].ReadOnly = true;
            //this.dgvpacking.Columns[2].ReadOnly = true;




            this.dgvpacking.Columns[2].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            ...
            if (w == 1024 && h == 768)
            {
                this.dgvpacking.Columns[0].Width = 45;
                this.dgvpacking.Columns[1].Width = 400;
                this.dgvpacking.Columns[2].Width = 100;
            ...
            else
            {
                this.dgvpacking.Columns[0].Width = 45;
                this.dgvpacking.Columns[1].Width = 400;
                this.dgvpacking.Columns[2].Width = 110;


            }


            dgvpacking.ColumnHeadersDefaultCellStyle.Font = new Font("Tahoma", 9.1F, FontStyle.Bold);
            foreach (DataGridViewColumn c in dgvpacking.Columns)
            {
                c.DefaultCellStyle.Font = new Font("Arial", 12F, GraphicsUnit.Pixel);
            }
        }
        ...
        private void LoadPortsDelivery()
        {
            ...
            dgvDelivery.ColumnCount = 3;


            dgvDelivery.Columns[0].Name = "S.NO";
            dgvDelivery.Columns[1].Name = "PackingName";
            ...
            if (w == 1024 && h == 768)
            {
                ...
                this.dgvDelivery.Columns[1].Width = 650;
            ...
            else
            {
                ...
                this.dgvDelivery.Columns[1].Width = 600;
        ...
        private void btntransactionpay_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (vali)
                {
                    string validaes = QuotationPaymentStatus(Txtpayquotationid.Text);

                    if (validaes == "0")
                    {
                        if (rbUpi != null && rbUpi.Checked)
                        {
                            if (ValidateUpiOnly())
                            {
                                string upiResult = SaveModeTransaction("UPI", lblcardammount.Text, txtUpiReference.Text);
                                if (upiResult == "1")
                                {
                                    savesales();
                                    FinishCardStylePayment();
                                }
                            }
                        }
                        else if (rbUpiCard != null && rbUpiCard.Checked)
                        {
                            if (ValidateUpiAndCard())
                            {
                                double totalAmount = Convert.ToDouble(lblpatroundoff.Text);
                                double cardAmount = Convert.ToDouble(lblcardammount.Text);
                                double upiAmount = totalAmount - cardAmount;
                                string cardResult = SaveModeTransaction("Card", Convert.ToString(cardAmount), txttransactionid.Text);
                                if (cardResult == "1")
                                {
                                    string upiResult = SaveModeTransaction("UPI", Convert.ToString(upiAmount), txtUpiReference.Text);
                                    if (upiResult == "1")
                                    {
                                        savesales();
                                        FinishCardStylePayment();
                        ...
                        else if (rbUpiCash != null && rbUpiCash.Checked)
                        {
                            if (ValidateUpiReference())
                            {
                                string upiResult = SaveModeTransaction("UPI", lblcardammount.Text, txtUpiReference.Text);
                                if (upiResult == "1")
                                {
                                    savesales();
                                    bool valis = Validation1();
                                    if (valis)
                                    {
                                        savepayment();
                        ...
                        {
                            //bool valiss = validationPaymentCheque();
                            //if (valiss)
                            //{
                    ...
                    else if (validaes == "1")
                    {
                        ...
                        MessageBox.Show("Payemnt Already completed");
                        clear();
                        ddlpaymode.Enabled = false;
                        rbpaymentCash.Enabled = false;
                        RbPaymentCard.Enabled = false;
            ...
            try
            {
                ...
                if (keyData == Keys.Escape)
                {
                    ...
                    if (selectedtab == "TabPayment")
                    {
                        ...
                        //else if (dgvNew.Rows.Count > 0 && !string.IsNullOrEmpty(Convert.ToString(dgvNew.Rows[0].Cells[1].Value)))
                        //{
                        else
                        {
                ...
                if (!string.IsNullOrEmpty(QuotationId))
                {
                    ...
                    if (result == DialogResult.Yes)
                    {
                        ...
                        using (SqlConnection con = new SqlConnection(Program.connection))
                        {
                            ...
                            cmd.CommandText = "GetQuotationEstimationreport_print_direct1";
                            cmd.Connection = con;
        ...
        private void btncreditsave_Click(object sender, EventArgs e)
        {
            if (selectedtab == "TabNew")
            {
                bool vali = estimationpayment();
                bool retuenSt = true;
                if (vali)
                {

                    string estimationdata = PaymentStatus(tatQuotationno.Text);
            ...
            if (selectedtab == "TabPayment")
            {
                ...
                if (vali)
                {
                    string SavePayemntvalid = QuotationPaymentStatus(Txtpayquotationid.Text);

                    if (SavePayemntvalid == "0")
                    {
            ...
            else if (selectedtab == "TabFloorCheckOut")
            {
                ...
                if (v == true)
                {
                    ...
                    if (valcheck)
                    {
                        ...
                        DataTable dt = DataGridView2DataTable(dgvpacking);
                        RemoveNullColumnFromDataTable(dt);
                        dt.Columns.RemoveAt(0);
                        dt.AcceptChanges();

                        DataTable dt1 = DataGridView2DataTable(dgvFloorCheckOut);
                        RemoveNullColumnFromDataTable(dt1);
                        ...
                        savecheck(dt, Program.userid, dt1);
                        searchcheckout("Estimationid", "", "Updatedon", "Today", "customername", "", role1, Program.userid);
                        itemdetailsval("");
                    }
                    else
            ...
            {
                bool vas = ValidationDeliverycheck();
            ...
            if (selectedtab == "TabCreditPayment")
            {
                savecreditapprovalPayment();
            }


        }
        private bool estimationpayment()
        {
            bool status = true;
            string message = "";
            int i = 0;
        ...
        public void savecreditapprovalPayment()
         {
             QuotationBal objQuotationbal = new QuotationBal();
             ...
             else if (radioButton1.Checked)
            {
             ...
             objQuotationbal.Quotationid = textBox10.Text;

             string output = objQuotationbal.SaveCreditPayment(objQuotationbal);
             if (output == "1")
             {
        ...
        private bool ValidationDeliverycheck()
        {
            bool status = true;
            string message = "";
            int i = 0;
            ...
            {
                DataGridViewCheckBoxCell CbxCell = (DataGridViewCheckBoxCell)row.Cells["ChkDelivery"];
        ...
        private bool Validationcheckout()
        {
            ...
            if (string.IsNullOrEmpty(txtcheckorderno.Text))
            {
                status = false;
            }
            return status;
        ...
        private bool ValidationPacking()
        {
            bool status = true;
            string message = "";
            if (dgvpacking.Rows.Count > 0)
            {
                ...
                string Items = Convert.ToString(dgvpacking.Rows[0].Cells[1].Value);
                string Received = Convert.ToString(dgvpacking.Rows[0].Cells[2].Value);
                if ((string.IsNullOrEmpty(Items) && string.IsNullOrEmpty(Received)))
                {
                    message = message + "* Please Select Packing" + "\n";
                }

                //if (i == 1)
                //    this.ActiveControl = dgvOrder;
            }
            else if (dgvpacking.Rows.Count == 0)
            {
                //i++;
                message = message + "* Please Select Packing" + "\n";
                //if (i == 1)
            ...
            for (int k = 0; k < dgvpacking.RowCount; k++)
            {
                string Items = Convert.ToString(dgvpacking.Rows[k].Cells[1].Value);
                string Received = Convert.ToString(dgvpacking.Rows[k].Cells[2].Value);


                if ((string.IsNullOrEmpty(Items.Trim()) && (string.IsNullOrEmpty(Received))))
                {
            ...
            if (sas == true)
            {
                ...
                message = message + "* Packing or  Quantity should not be empty." + "\n";
                //if (i == 1)
                //    this.ActiveControl = dgvpacking;
            }
        ...
        public void bindcustomer_payment()
        {
        ...
        {
            comboBox2.DataSource = objQuotationbal.GetProductsusername();
        ...
        private void dgvNew_CellLeave(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (!String.IsNullOrEmpty(Convert.ToString(dgvNew.Rows[dgvNew.CurrentCell.RowIndex].Cells[5].Value)))
                {
                    ...
                    //{
                    //amt = rate * Convert.ToDecimal(tb.Text);

                    amt = rate * Convert.ToDecimal(dgvNew.Rows[dgvNew.CurrentCell.RowIndex].Cells[5].Value);
                    //amt = Math.Round(amt);
        ...
        public void RemoveNullColumnFromDataTable(DataTable dt)
        {
            for (int i = dt.Rows.Count - 1; i >= 0; i--)
            {
                if (MainTabSalesBill.SelectedTab.Name == "TabNew" || MainTabSalesBill.SelectedTab.Name == "TabDelivery")
                {
                    if (string.IsNullOrEmpty(Convert.ToString(dt.Rows[i][1])) || string.IsNullOrEmpty(Convert.ToString(dt.Rows[i][3])))
                        dt.Rows[i].Delete();
                }
                else if (MainTabSalesBill.SelectedTab.Name == "TabCreditApproval" || MainTabSalesBill.SelectedTab.Name == "TabPayment")
                {
                ...
                else if (MainTabSalesBill.SelectedTab.Name == "TabFloorCheckOut")
                {
        ...
        {
            objQuotationbal.UpdateEstinationid = EstimationId;
            objQuotationbal.UpdateQuotationid = QuotationIdVal;
           
             if (radioButton6.Checked)
            {
                objQuotationbal.UpdatePaymentmode = "Credit Bill";
                objQuotationbal.CustomerIdUpdate = Convert.ToString(comboBox1.SelectedValue);
                objQuotationbal.Customernames = Convert.ToString(comboBox1.Text.Trim());

            }
             else if (radioButton4.Checked)
            {
                objQuotationbal.UpdatePaymentmode = "Partial Credit Bill";
                objQuotationbal.CustomerIdUpdate = Convert.ToString(comboBox1.SelectedValue);
                objQuotationbal.Customernames = Convert.ToString(comboBox1.Text.Trim());
            }
             else if (radioButton5.Checked)
             {
                 objQuotationbal.UpdatePaymentmode = "Cash Bill";
                 objQuotationbal.CustomerIdUpdate = Convert.ToString(comboBox1.SelectedValue);
                 objQuotationbal.Customernames = Convert.ToString(comboBox1.Text.Trim());
             }
            string output = objQuotationbal.UpdateEstimationEstimation(objQuotationbal);
        }
        public void save(int v)
        {
            ...
            objQuotationbal.Assistnames = Convert.ToString(comboBox2.SelectedValue);
            ...
            objQuotationbal.Creditstatus = Creditapproved.Text;
            if (rbCash.Checked)
            {
            ...
            if (output[1] == "3")
            {
                ...
                //cusbool = 1;
                //DialogResult result = MessageBox.Show("Phone No Already Exist. Do You Want Update Customer Name ?", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question);

                //if (result == DialogResult.Yes)
                //{
                //    objQuotationbal.cusbool = cusbool;
                //    objQuotationbal.Customerid = output[0];
                //    string[] output1 = objQuotationbal.SaveEstimation(objQuotationbal, dt);
        ...
        public void getEstimation(string s)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                comboBox2.SelectedValue = Convert.ToInt32(ds.Tables[0].Rows[0]["AssistName"]);
        ...
        public void getCheckout(string s)
        {
            ...
            if (ds.Tables[1].Rows.Count > 0)
            {
               ...
               // panel2.Enabled = false;
                dgvpacking.Focus();
                dgvpacking.CurrentCell = dgvpacking[1, 0];
        ...
        public void getpay(string s)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
               ...
               // comboBox1.Enabled = false;
                ...
                textBox18.Text = Convert.ToString(ds.Tables[0].Rows[0]["AssistName"]);
        ...
        public void getpayCredit(string s)
        {
            DataSet ds = objQuotationbal.BindbillpayCredit(s);
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                textBox10.Text = Convert.ToString(ds.Tables[0].Rows[0]["Estimationid"]);
                textBox3.Text = Convert.ToString(ds.Tables[0].Rows[0]["customername"]);
                textBox5.Text = Convert.ToString(ds.Tables[0].Rows[0]["City"]);
                textBox8.Text = Convert.ToString(ds.Tables[0].Rows[0]["Name"]);

                textBox13.Text = Convert.ToString(ds.Tables[0].Rows[0]["Updatedby"]);

                textBox12.Text = Convert.ToString(ds.Tables[0].Rows[0]["UserFullName"]);

                dateTimePicker1.Value = Convert.ToDateTime(ds.Tables[0].Rows[0]["date"]);

                if(Convert.ToString(ds.Tables[0].Rows[0]["Paymentmode"]) == "Cash")
                {
                    radioButton2.Checked = true;
                }
                else if (Convert.ToString(ds.Tables[0].Rows[0]["Paymentmode"]) == "Credit Bill")
                {
                    radioButton3.Checked = true;
                }
                else if (Convert.ToString(ds.Tables[0].Rows[0]["Paymentmode"]) == "Partial Credit Bill")
                {
                    radioButton1.Checked = true;
                }
                //label162.Text = Convert.ToString(ds.Tables[0].Rows[0]["Paymentmode"]);
                //if (string.IsNullOrEmpty(Convert.ToString(ds.Tables[0].Rows[0]["Paymentmode"]=="Cash")))
                //{
                //    radioButton2.Checked = true;
                //}
                //else if (string.IsNullOrEmpty(Convert.ToString(ds.Tables[0].Rows[0]["Paymentmode"] == "Credit Bill") ))
                //{
                //    radioButton3.Checked = true;
                //}
                //else if (string.IsNullOrEmpty(Convert.ToString(ds.Tables[0].Rows[0]["Paymentmode"] == "Partial Credit Bill")))
                //{
                //    radioButton1.Checked = true;
                //}
                textBox9.Text = Convert.ToString(ds.Tables[0].Rows[0]["Quotationid"]);

                textBox11.Text = Convert.ToString(ds.Tables[0].Rows[0]["Remarks"]);
                label159.Text = Convert.ToString(ds.Tables[0].Rows[0]["Total"]);
                label146.Text = Convert.ToString(ds.Tables[0].Rows[0]["LessAmount"]);
                label142.Text = Convert.ToString(ds.Tables[0].Rows[0]["others"]);
                label156.Text = Convert.ToString(Convert.ToDouble(label159.Text) + Convert.ToDouble(label142.Text) - Convert.ToDouble(label146.Text));

                double value = Math.Round(Convert.ToDouble(label159.Text));
                label153.Text = Convert.ToString(value);
                //  panel2.Enabled = false;
            }
            else
            {
            ...
            if (ds.Tables[1].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[1].Rows.Count; i++)
                {
                    dvgcreditpayment.Rows.Add();
                    dvgcreditpayment.Rows[i].Cells[0].Value = i + 1;
                    dvgcreditpayment.Rows[i].Cells[1].Value = Convert.ToString(ds.Tables[1].Rows[i]["DisplayName"]);
                    dvgcreditpayment.Rows[i].Cells[2].Value = Convert.ToString(ds.Tables[1].Rows[i]["UOM"]);
                    dvgcreditpayment.Rows[i].Cells[3].Value = Convert.ToString(ds.Tables[1].Rows[i]["Productid"]);

                    double qty = Convert.ToDouble(ds.Tables[1].Rows[i]["Rate"]);
                    dvgcreditpayment.Rows[i].Cells[4].Value = qty;
                    dvgcreditpayment.Rows[i].Cells[5].Value = Convert.ToString(ds.Tables[1].Rows[i]["Quantity"]);

                    double amt = Convert.ToDouble(ds.Tables[1].Rows[i]["Amount"]);
                    dvgcreditpayment.Rows[i].Cells[6].Value = amt;
        ...
        {
            DataTable dt = objQuotationbal.searchPacking(firstname, firstvalue, secondname, secondvalue, thirdname, thirdvalue, role1, Program.userid);
            dgvSearch.DataSource = null;
            if (dt.Rows.Count > 0)
            {
                dgvSearch.DataSource = dt;
        ...
        public void savecheck(DataTable dt, string userid, DataTable dt1)
        {


            string output = objQuotationbal.SaveEstimationPacking(txtcheckorderno.Text, dt, userid, dt1);
            if (output == "1")
            {
                //Pnloading1.Visible = false;
                clear();
        ...
        //public void savecreditapprovalPayment(string s)
        //{

        //    // Pnloading3.Visible = true;
        //    string output = objQuotationbal.savecreditapprovalPayment();
        //    if (output == "1")
        //    {
        //        // Pnloading3.Visible = false;
        //        clear();
        ...
        public void SearchCreditPayment(string firstname, string firstvalue, string secondname, string secondvalue, string thirdname, string thirdvalue, string role, string UserId)
        {
            DataTable dt = objQuotationbal.SearchCreditPayment(firstname, firstvalue, secondname, secondvalue, thirdname, thirdvalue, role1, Program.userid);
            dgvSearch.DataSource = null;
            if (dt.Rows.Count > 0)
            {
                dgvSearch.DataSource = dt;
        ...
        public void Applications_Idle(object sender, EventArgs e)
        {
        ...
        private void lblcutomerpay_Click(object sender, EventArgs e)
        {
            ...
            bool valid = Validation1();
            if (valid)
            {
                string validae = QuotationPaymentStatus(Txtpayquotationid.Text);
            ...
            if (valis)
            {
                ...
                else if (rbUpiCash != null && rbUpiCash.Checked)
                {
                    ...
                    else
                    {
                        ...
                        pntransction.Visible = true;
                        lnkbackcard.Visible = true;
                        paymentDenotoCustomer();
                        lblcardammount.Text = Convert.ToString(val);
                        checkval = val.ToString();
                        label105.Text = Convert.ToString(val);
                        cashpl.Visible = true;
                        ShowCardEntryFields(false);
                        ShowUpiReference(true);
                        txtUpiReference.Focus();
                    }
                }
                else if (Rdcashcard.Checked)
                {
                ...
                {
                    string savestatus = QuotationPaymentStatus(Txtpayquotationid.Text);
                    ...
                    if (savestatus=="0")
                    {
                        if (Convert.ToDouble(lblpaymentamount.Text) > Convert.ToDouble(lblpaymenttotal.Text))
                        {
                            if (lblpaymentmode.Text == "Partial Credit Bill")
                            {
                                ...
                                if (Rdcashcard.Checked)
                                {
                                    if (lblcardammount.Text =="0")
                                    {
                                        objQuotationbal.OAmounts = "0";
                                    }
                                    else
                                    {
                                        objQuotationbal.OAmounts = Convert.ToString(lblpatroundoff.Text);
                                    }
        ...
        {
            double total = 0.0;
            if (Rdcashcard.Checked || (rbUpiCash != null && rbUpiCash.Checked))
            {
            ...
            //string Alredy = lblid.Text;
            //if (Alredy == "Already Payment Completed")
            //{
            //    MessageBox.Show(Alredy);
            //}
            //else
            //{
                paymentdenobind();
        ...
        public string PaymentStatus(string QuotationID)
        {



            string s = objQuotationbal.CheckPaymentStatus(QuotationID);

            return s;
        }

        public string QuotationPaymentStatus(string QuotationID)
        {



            string Paymentid = objQuotationbal.CheckPayment(QuotationID);

            return Paymentid;
        }

        private void AddUpiPaymentModes()
        {
            groupBox3.Size = new Size(360, 68);
            label56.Location = new Point(6, 522);
            txtpayremarks.Location = new Point(64, 520);

            rbUpi = new RadioButton();
            rbUpi.AutoSize = true;
            rbUpi.Text = "UPI";
            rbUpi.Location = new Point(6, 40);
            rbUpi.CheckedChanged += new EventHandler(RbUpi_CheckedChanged);

            rbUpiCash = new RadioButton();
            rbUpiCash.AutoSize = true;
            rbUpiCash.Text = "UPI and Cash";
            rbUpiCash.Location = new Point(60, 40);
            rbUpiCash.CheckedChanged += new EventHandler(RbUpiCash_CheckedChanged);

            rbUpiCard = new RadioButton();
            rbUpiCard.AutoSize = true;
            rbUpiCard.Text = "UPI and Card";
            rbUpiCard.Location = new Point(170, 40);
            rbUpiCard.CheckedChanged += new EventHandler(RbUpiCard_CheckedChanged);

            groupBox3.Controls.Add(rbUpi);
            groupBox3.Controls.Add(rbUpiCash);
            groupBox3.Controls.Add(rbUpiCard);

            lblUpiReference = new Label();
            lblUpiReference.AutoSize = true;
            lblUpiReference.Text = "UPI Reference";
            lblUpiReference.Location = new Point(3, 148);
            lblUpiReference.Visible = false;

            txtUpiReference = new TextBox();
            txtUpiReference.Location = new Point(130, 145);
            txtUpiReference.Size = new Size(215, 27);
        ...
        private bool IsUpiModeSelected()
        {
            return (rbUpi != null && rbUpi.Checked) || (rbUpiCash != null && rbUpiCash.Checked) || (rbUpiCard != null && rbUpiCard.Checked);
        }

        private void SetUpiModesEnabled(bool enabled)
        {
            if (rbUpi != null)
            {
                rbUpi.Enabled = enabled;
                rbUpiCash.Enabled = enabled;
                rbUpiCard.Enabled = enabled;
            }
        }

        private void ClearUpiModes()
        {
            if (rbUpi == null)
            {
                return;
            ...
            rbUpi.Checked = false;
            rbUpiCash.Checked = false;
            rbUpiCard.Checked = false;
            txtUpiReference.Text = string.Empty;
            ShowUpiReference(false);
        }
        ...
        private void ShowUpiReference(bool show)
        {
            ...
            if (show && rbUpiCard.Checked)
            {
                lblUpiReference.Location = new Point(3, 155);
                txtUpiReference.Location = new Point(130, 152);
                pntransction.Size = new Size(378, 230);
                panelTransaction.Size = new Size(379, 260);
                btntransactionpay.Location = new Point(297, 190);
            }
            else if (show)
            {
                lblUpiReference.Location = new Point(3, 55);
                txtUpiReference.Location = new Point(130, 51);
                pntransction.Size = new Size(378, 188);
                panelTransaction.Size = new Size(379, 216);
                btntransactionpay.Location = new Point(297, 157);
            }
            else
            {
                pntransction.Size = new Size(378, 188);
        ...
        private void ShowCardEntryFields(bool show)
        {
            ...
            if (!show)
            {
                cmbbank.SelectedIndex = cmbbank.Items.Count > 0 ? 0 : -1;
                txtcardno.Text = string.Empty;
                txttransactionid.Text = string.Empty;
            }
        }
        ...
        private void RbUpi_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lblcardammount.Text = String.Format("{0:00.00}", Convert.ToDouble(lblpatroundoff.Text));
            label105.Text = lblcardammount.Text;
            cashpl.Visible = false;
            panelCustomerpaid.Visible = false;
            panelTransaction.Visible = true;
            pntransction.Visible = true;
        ...
        private void RbUpiCash_CheckedChanged(object sender, EventArgs e)
        {
            if (!rbUpiCash.Checked)
            {
                return;
            }
            lblpaymentamount.Text = String.Format("{0:00.00}", Convert.ToDouble(lblpatroundoff.Text));
        ...
        private void RbUpiCard_CheckedChanged(object sender, EventArgs e)
        {
            if (!rbUpiCard.Checked)
            {
                return;
            }
            lblcardammount.Text = string.Empty;
            cashpl.Visible = false;
            panelCustomerpaid.Visible = false;
            panelTransaction.Visible = true;
            pntransction.Visible = true;
        ...
        private bool ValidateUpiReference()
        {
            string referenceText = txtUpiReference.Text == null ? "" : txtUpiReference.Text.Trim();
            if (referenceText.Length == 0)
            {
                MessageBox.Show("Enter UPI Payment Reference");
                txtUpiReference.Focus();
                return false;
            }
            if (referenceText.Length > 30)
            {
                MessageBox.Show("UPI Payment Reference cannot be more than 30 characters");
                txtUpiReference.Focus();
                return false;
            }
        ...
        private bool ValidateUpiAndCard()
        {
            if (cmbbank.SelectedIndex == 0)
            {
                MessageBox.Show("Select Your Account");
                cmbbank.Focus();
                return false;
            }
            if (string.IsNullOrEmpty(txtcardno.Text))
            ...
            if (string.IsNullOrEmpty(txttransactionid.Text))
            {
                MessageBox.Show("Enter Transction  No");
                txttransactionid.Focus();
                return false;
            }
            if (string.IsNullOrEmpty(lblcardammount.Text) || lblcardammount.Text == ".")
            {
                MessageBox.Show("Enter Your Amount");
                lblcardammount.Focus();
                return false;
            }
            if (!ValidateUpiReference())
            {
            ...
            {
                MessageBox.Show("Enter a Card amount less than the total. The remaining amount is UPI.");
                lblcardammount.Focus();
                return false;
            }
            return true;
        ...
        private string SaveModeTransaction(string mode, string amount, string instrumentSource)
        {
            objQuotationbal.Quotationid = txtpayorderno.Text;
            ReceiptId = txtpayorderno.Text;
            if (mode == "UPI")
            {
                objQuotationbal.Bank = "";
                objQuotationbal.Cardnumber = "";
            }
            else
            {
            ...
            objQuotationbal.transid = instrumentSource;
            objQuotationbal.OAmount = amount;
            objQuotationbal.type = mode;
            return objQuotationbal.savecardtransaction(objQuotationbal);
        }

        private void FinishCardStylePayment()
        {
            UpdateFunction();
            ddlpaymode.Enabled = false;
            rbpaymentCash.Enabled = false;
        ...
        public void savesales()
        {
           ...
           // panel2.Enabled = false;
            ...
            objQuotationbal.Customername = Convert.ToString(comboBox1.Text.Trim());
            objQuotationbal.City = Convert.ToString(txtpaycity.Text);

            //objQuotationbal.Referenceid = Convert.ToString();
            //objQuotationbal.Assist = Convert.ToString(cmbassistby.SelectedValue);
            objQuotationbal.Paymentmode = SelectedCardPaymentMode();
            objQuotationbal.Updatedby = Program.userid;
            ...
            {
                SaveSalesPaymentDetails(output);
                panel1.Enabled = true;
               // panel2.Enabled = true;
                //Pnloading.Visible = false;
                //getsaleamount();
        ...
        private string SelectedCardPaymentMode()
        {
            if (rbUpiCard != null && rbUpiCard.Checked)
            {
                return "UPI and Card";
            }
            if (rbUpiCash != null && rbUpiCash.Checked)
            {
                return "UPI and Cash";
            }
            if (rbUpi != null && rbUpi.Checked)
        ...
        private decimal ParsePayAmount(string text)
        {
            decimal amount;
        ...
        private void SaveSalesPaymentDetails(string salesId)
        {
            string mode = SelectedCardPaymentMode();
            decimal grand = ParsePayAmount(lblpatroundoff.Text);
            decimal entered = ParsePayAmount(lblcardammount.Text);
            ...
            {
                upiAmount = entered;
                upiReference = txtUpiReference.Text.Trim();
            }
            else if (mode == "UPI and Card")
            {
                cardAmount = entered;
                upiAmount = grand - cardAmount;
                if (upiAmount < 0)
                {
                    upiAmount = 0;
                }
                bank = cmbbank.Text.Trim();
                cardNumber = txtcardno.Text.Trim();
                cardTransId = txttransactionid.Text.Trim();
                upiReference = txtUpiReference.Text.Trim();
            }
            else if (mode == "UPI and Cash")
            {
                upiAmount = entered;
                cashAmount = ParsePayAmount(lblpaymenttotal.Text) - ParsePayAmount(lblpaidbalance.Text);
                if (cashAmount < 0)
                {
                    cashAmount = 0;
                }
            ...
            try
            {
                ...
                {
                    con.Open();
                    SqlCommand cmd = new SqlCommand("UPDATE Sales SET Paymentmode=@Paymentmode, CashAmount=@CashAmount, CardAmount=@CardAmount, UpiAmount=@UpiAmount, CardBank=@CardBank, CardNumber=@CardNumber, CardTransId=@CardTransId, UpiReference=@UpiReference WHERE Salesid=@Salesid", con);
                    cmd.Parameters.AddWithValue("@Paymentmode", mode);
                    AddPayAmountParameter(cmd, "@CashAmount", cashAmount);
                    AddPayAmountParameter(cmd, "@CardAmount", cardAmount);
                    AddPayAmountParameter(cmd, "@UpiAmount", upiAmount);
                    cmd.Parameters.AddWithValue("@CardBank", bank.Length == 0 ? (object)DBNull.Value : bank);
            ...
            {
                MessageBox.Show("Sales bill " + salesId + " was saved, but the payment details were not saved on the bill." + Environment.NewLine + ex.Message);
            }
        }

        private static void AddPayAmountParameter(SqlCommand cmd, string name, decimal amount)
        {
        ...
        public void getDelivery(string s)
        {
            ...
            if (ds.Tables[1].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[1].Rows.Count; i++)
                {
                    ...
                    dgvDelivery.Rows[i].Cells[1].Value = Convert.ToString(ds.Tables[1].Rows[i]["packingName"]);
        ...
        public void savedelivered(DataTable dt)
        {
            //  Pnloading6.Visible = true;
            string s = objQuotationbal.savedelivered(Txtdeliveryorderno.Text, dt, Program.userid);
        ...
        public void bindPackingMaster()
        {
            ddlpacking.DataSource = objQuotationbal.getPackingMaster1();
            ddlpacking.DisplayMember = "PackingName";
            ddlpacking.ValueMember = "id";
        }
        public AutoCompleteStringCollection ClientListDropDown()
        {
            ...
            try
            {
                DataTable dt = objQuotationbal.getPackingMaster();
                if (dt.Rows.Count > 0)
                {
                    for (int i = 0; i <= dt.Rows.Count; i++)
                    {
                        asc.Add(Convert.ToString(dt.Rows[i]["PackingName"]));
                    }
                }
        ...
        private void dgvpacking_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            dgvpacking.Rows[dgvpacking.CurrentCell.RowIndex].Cells[0].Value = dgvpacking.CurrentCell.RowIndex + 1;
            if (e.ColumnIndex == 1)
            {
                panel22.Visible = true;
                ddlpacking.Visible = true;
                button4.Visible = true;
                Txtpackinsearch.Visible = false;
                btnAddpacking.Visible = false;
                ddlpacking.Focus();
                ddlpacking.SelectedIndex = 0;
        ...
        private void dgvpacking_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (dgvpacking.CurrentCell.ColumnIndex == 2)
                {
                    dgvpacking.Focus();
                    dgvpacking.CurrentCell = dgvpacking[1, dgvpacking.CurrentCell.RowIndex + 1];
                    //edit1 = true;
                }
            }
            catch
        ...
        private void dgvpacking_SelectionChanged(object sender, EventArgs e)
        {
            try
            {
                if (edit1 == true)
                {
                    if (dgvpacking.CurrentCell.RowIndex >= 1)
                    {
                        dgvpacking.CurrentCell = dgvpacking[dgvpacking.CurrentCell.ColumnIndex, dgvpacking.CurrentCell.RowIndex - 1];
                        edit1 = false;
                    }
                    else if (dgvpacking.CurrentCell.RowIndex == 0)
                    {
                        dgvpacking.CurrentCell = dgvpacking[dgvpacking.CurrentCell.ColumnIndex, dgvpacking.CurrentCell.RowIndex - 1];
                    }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            Txtpackinsearch.SelectionStart = 0;
            Txtpackinsearch.SelectionLength = Txtpackinsearch.Text.Length;
        }

        private void Txtpackinsearch_KeyDown(object sender, KeyEventArgs e)
        {
            //if (e.KeyData == Keys.Enter)
            //{
            //    if (!string.IsNullOrEmpty(Txtpackinsearch.Text))
            //    {
            //        int s = objQuotationbal.savePackingMaster(Txtpackinsearch.Text, Program.userid);

            //        dgvpacking.Rows[dgvpacking.CurrentCell.RowIndex].Cells[1].Value = Txtpackinsearch.Text;
            //        dgvpacking.Focus();
            //        dgvpacking.CurrentCell = dgvpacking.Rows[dgvpacking.CurrentCell.RowIndex].Cells[2];
            //        button5.PerformClick();
            //        dgvpacking.Focus();
            //    }
            //    else
            //    {
            //        MessageBox.Show("Please Enter Packing Item");
            //        panel22.Visible = true;
            //        Txtpackinsearch.Focus();
            //    }
            //}
        ...
        private void dgvpacking_EditingControlShowing(object sender, DataGridViewEditingControlShowingEventArgs e)
        {
            TextBox s = new TextBox();
            int column = dgvpacking.CurrentCell.ColumnIndex;
            string headerText = dgvpacking.Columns[column].HeaderText;

            if (headerText.Equals("Quantity"))
            {
                s = e.Control as TextBox;
                s.MaxLength = 5;
                s.KeyPress += s_KeyPress;
            }
        }

        private void s_KeyPress(object sender, KeyPressEventArgs args)
        {
        ...
        private void btnAddpacking_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(Txtpackinsearch.Text))
            {
                objQuotationbal.savePackingMaster(Txtpackinsearch.Text, Program.userid);
                Txtpackinsearch.Text = "";
                bindPackingMaster();
                ddlpacking.SelectedIndex = 0;
                ddlpacking.Visible = true;
                button4.Visible = true;
        ...
        private void ddlpacking_SelectedIndexChanged(object sender, EventArgs e)
        {
             //if (ddlpacking.SelectedValue != "")
             //{


             //    dgvpacking.Rows[dgvpacking.CurrentCell.RowIndex].Cells[1].Value = ddlpacking.SelectedValue;
             //    dgvpacking.Focus();
             //    dgvpacking.CurrentCell = dgvpacking.Rows[dgvpacking.CurrentCell.RowIndex].Cells[2];
             //    button5.PerformClick();
             //    dgvpacking.Focus();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            Txtpackinsearch.Visible = true;
            btnAddpacking.Visible = true;

            Txtpackinsearch.Focus();
        }

        /*private void ddlpacking_SelectedValueChanged(object sender, EventArgs e)
        {


            MessageBox.Show(ddlpacking.Items[ddlpacking.SelectedIndex].ToString());

            if (!string.IsNullOrEmpty(ddlpacking.SelectedText) || ddlpacking.SelectedText != "--Select--")
            {
                //string xx = ((System.Data.DataRowView)(ddlpacking.SelectedValue))["name"].ToString();

                //int s = objQuotationbal.savePackingMaster(Txtpackinsearch.Text, Program.userid);

                dgvpacking.Rows[dgvpacking.CurrentCell.RowIndex].Cells[1].Value = ddlpacking.SelectedText;
                dgvpacking.Focus();
                dgvpacking.CurrentCell = dgvpacking.Rows[dgvpacking.CurrentCell.RowIndex].Cells[2];
                button5.PerformClick();
                dgvpacking.Focus();
            ...
            {
                MessageBox.Show("Please Select Packing Item");
                panel22.Visible = true;
                ddlpacking.Focus();
            }
            }*/

        private void ddlpacking_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            if (ddlpacking.SelectedIndex > 0){
                //MessageBox.Show(ddlpacking.Text + ", " + ddlpacking.SelectedText + ", " + ddlpacking.SelectedValue);
                dgvpacking.Rows[dgvpacking.CurrentCell.RowIndex].Cells[1].Value = ddlpacking.Text;
                dgvpacking.Focus();
                dgvpacking.CurrentCell = dgvpacking.Rows[dgvpacking.CurrentCell.RowIndex].Cells[2];
                button5.PerformClick();
                dgvpacking.Focus();
        ...
        private void lessbtnpament_Click(object sender, EventArgs e)
        {
            panel24.Visible = true;
            textlesspayment.Text = string.Empty;
            this.ActiveControl = textlesspayment;
        }
        ...
        {
            if (string.IsNullOrEmpty(textlesspayment.Text))
            {
                MessageBox.Show("Password should not be empty");
                this.ActiveControl = textlesspayment;
                return;
            }
            DataTable dt = LoginBAL.GetLesserDetials(textlesspayment.Text, "LESS");
            if (dt.Rows.Count > 0)
            {
        ...
        private void Paymnet_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void dvgdenomainationpaymnet_EditingControlShowing(object sender, DataGridViewEditingControlShowingEventArgs e)
        {
           
        }

        private void dvgdenomainationpaymnet_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
        ...
        //{
        //    double totalamount = 0;
        //    for (int i = 0; i < dvgdenomainationpaymnet.Rows.Count; i++)
        //    {
        //        totalamount = totalamount + Convert.ToDouble(dvgdenomainationpaymnet.Rows[i].Cells[2].Value);
        //    }

        //    label171.Text = String.Format("{0:00.00}", totalamount);

        //    double val = Convert.ToDouble(label165.Text) - Convert.ToDouble(label171.Text);
        //    label166.Text = String.Format("{0:00.00}", val);
        //}
        ...
        //}
        public void totalvalbalances()
        {
           


        }
        public void paymentDenotosCustomerbind()
        {
        ...
        private void RadioButton_CheckedChanged(object sender, EventArgs e)
        {
            ...
            else if (radioButton6.Checked)
            {
                ...
                cashpl.Visible = false;
                panelCustomerpaid.Visible = false;
                lblpaymentmode.Text = radioButton6.Text;
                RbPaymentCard.Checked = false;
                rbpaymentCash.Checked = false;
                Rdcashcard.Checked = false;
                ClearUpiModes();
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                cmdcity.Text = objQuotationbal.bindcity(Convert.ToString(comboBox1.SelectedValue));
            }
        }
