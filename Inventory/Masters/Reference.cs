    ...
    public partial class Reference : Form
    {
        ...
        private void pbxRightCollapse_Click(object sender, EventArgs e)
        {
            if (pnlCollapse2.Visible == true)
            {
                ...
                this.dgvSearch.Columns["ReferencesID"].Visible = true;
        ...
        private void InsertUpdateRightToInformation()
        {
            ...
            ObjReferenceBal.CityId = Convert.ToString(cmbbxCity.SelectedValue);
            ...
            {
                MessageBox.Show("Reference already exist ");
        ...
        public void GetProduct()
        {
            ...
            dgvCustomerinfo.DataSource = dt;
            dgvCustomerinfo.Columns["ReferencesID"].Visible = false;
        ...
        private bool Validation()
        {
            ...
            {
                i++;
                message = message + "* Reference Name Should Not Be Empty" + "\n";
                if (i == 1)
                    this.ActiveControl = txtCustomerName;
            }
        ...
        private void dgvCustomerinfo_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                else if (dgvCustomerinfo.Columns[e.ColumnIndex].HeaderText == "Delete")
                {
                    ...
                    DialogResult result = MessageBox.Show("Do You Want To Delete Reference " + namestatus + "?", "Delete Reference?", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
        ...
        {
            int result = 0;
            result = ReferenceBAL.deletereference(Convert.ToInt32(lblhidden.Text));
            return result;
        }
        ...
        public void GetRefrenceBalanceSearch()
        {

            DataTable dt = ReferenceBAL.GetRefrenceBalanceSearch(txtsearch1.Text, txtsearch2.Text);
        ...
        public void GetRefrenceBalanceSearchButton()
        {

            DataTable dt = ReferenceBAL.GetRefrenceBalanceSearchButton(txtprodsearch.Text);
            //dgvReceivableBalance.DataSource = dt;
            dgvCustomerinfo.Columns.Clear();
            dgvCustomerinfo.DataSource = dt;
            dgvCustomerinfo.Columns["ReferencesID"].Visible = false;
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            if (txtprodsearch.Focused)
            {
                if (keyData == (Keys.Enter))
                {
                        ...
                        GetRefrenceBalanceSearchButton();
        ...
        {
            DataTable dt = ReferenceBAL.searchreference(firstname, firstvalue, secondname, secondvalue, thirdname, thirdvalue);
            ...
            dgvSearch.Columns["ReferencesID"].Visible = false;
        ...
        private void dgvSearch_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                lblhidden.Text = Convert.ToString(dgvSearch.Rows[e.RowIndex].Cells["ReferencesID"].Value);
        ...
        private void txtprodsearch_Click(object sender, EventArgs e)
        {
