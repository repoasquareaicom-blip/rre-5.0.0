...
{
    public partial class IssuedTray : Form
    {
        ...
        {
            DataTable dt = objServiceRequestBAL.SearchDataissuedTray("Delivered");
        ...
        private void dgvSearch_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                dtAdd = objServiceRequestBAL.GetserviceProductTray("Delivered", lblservicerequestid.Text.Trim());
        ...
        private void IssuedTray_Load(object sender, EventArgs e)
        {
