...
const fieldNames = {
  ...
  updatedOn: ['TransactionDate', 'transactionDate', 'UpdatedOn', 'updatedOn', 'Updatedon'],
  ...
  summaryGrossValue: ['SummaryGrossValue', 'summaryGrossValue'],
  summaryLessAmount: ['SummaryLessAmount', 'summaryLessAmount'],
...
export function normalizeEstimationRows(rows) {
  return rows.map((row, index) => {
    ...
    return {
      ...
      grossValue: toNumber(getValue(row, fieldNames.grossValue)) || 0,
      ...
      summary: {
        ...
        grossValue: toNumber(getValue(row, fieldNames.summaryGrossValue)) || 0,
        lessAmount: toNumber(getValue(row, fieldNames.summaryLessAmount)) || 0,
